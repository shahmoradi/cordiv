...
The directory 'pdb_prop', contains the pdb-level properties of all pdb structures, each in a single file.

The directory 'rl_pdb_prop', contains the residue-level properties of the pdb files, each in a separate file corresponding to the pdb structure.

Last updated by:   Amir Shahmoradi, 5:50 PM, July 17 2014, iCMB, UT Austin
