...
\label{sec:results}
    ...
    \subsection*{Sequence divergence as the main Determinant of Sequence-Structure Relation}
        ...
        In order to identify the potential contributing factors to the strength of sequence--structure correlations, we first employ one of the simplest nonparametric yet powerful tests of statistical dependence, that is, we construct the Spearman correlation matrix of all pdb-level structure and sequence properties. The choice of Spearman versus the popular Pearson's correlation measure is to minimize the effects of any nonlinear relationships between the variables on the strengths of the correlations. As summary of the most influential factors to structure-sequence relations is illustrated in Figure \ref{fig:}.
        ...
        -- most importantly WCN, RSA \ddg Entropy, and Voronoi cell volume and surface area --
