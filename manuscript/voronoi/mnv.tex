...
\section{Results}
    ...
    \subsection*{Effect of Long-Range Amino Acid Interactions on Sequence Variability}
...
\newpage
    ...
    \begin{figure}
        \begin{center}
        \includegraphics[width=5.5in]{best_structural_predictors_of_ER_given_VSCvolume.pdf}
        \end{center}
