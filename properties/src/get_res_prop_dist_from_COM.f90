...
! This code used the output data from get_pdb_prop_CO.f90 and get_res_crd_bf.py
...
do ii = 1,npdb
  ...
  do i = 1,nres
    ...
    write(output_unit,'(2A25,1I25,4E25.5)') pdb, res_name(i), res_num(i), distance(i), bfactor(i), bfactor_min(i), bfactor_max(i)
  end do
