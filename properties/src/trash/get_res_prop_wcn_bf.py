# Last updated by Amir Shahmoradi, 5:56 PM, Thursday Aug 21 2014, Wilke Lab, iCMB, The University of Texas at Austin.
# ATTN: this Python code works just fine, but is very slow and takes about 2 hours to finish all the calculations. Use instead, the newer version that uses the number crunching power of Fortran along with flexibility of Python, in the upper directory.
