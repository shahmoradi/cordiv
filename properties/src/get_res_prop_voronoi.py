...
Usage:'''
        ...
        sum_CA = sys.argv[2]   # summary file containing all residue vornoi properties for CA coordinates
        sum_SC = sys.argv[3]   # summary file containing all residue vornoi properties for SC coordinates
        sum_AA = sys.argv[4]   # summary file containing all residue vornoi properties for AA coordinates
