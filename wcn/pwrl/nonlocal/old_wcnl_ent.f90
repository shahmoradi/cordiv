...
! NOW WRITE OUT THE FIRST FOUR LINES OF THE OUTPUT WCN FILE
  ! open output files:
    ...
    if (sum_out_exists) then
      ...
      write(sum_out_unit,'(6A20)') 'pdb_name','best_exp','Spearman','Sp(alpha=-2)','Sp_diff','nres'
    end if
