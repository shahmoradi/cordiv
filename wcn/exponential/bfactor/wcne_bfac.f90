...
! variables and parameters for wcn calculations and correlations:
  real*8 , parameter                      :: expmean_min = 0.0d0                                ! expmean stands for STandard DEViation.
  real*8 , parameter                      :: expmean_max = 50.d0                                ! expmean stands for STandard DEViation.
  real*8 , parameter                      :: expmean_stride = 0.2                               ! expmean stands for STandard DEViation.
