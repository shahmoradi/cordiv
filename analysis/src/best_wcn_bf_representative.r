# Here I wanna see which atom of the residues is the best representative of the of properties that are defined for the entire residue, that is, WCN and Bfactor (bf).
# My finding so far is that average Bfactor over the entire sidechain correlates the best with ddGent and seqent, and so does wcnSC, compared to wcnCA, wcnAA, and other atoms WCNs.
# However, in order to document this difference, here I am going to focus specifically on the correlations of these variables with other residue properties. 
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX   This code is incomplete
