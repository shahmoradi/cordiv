...
for(pdb in levels(res_prop_elj$pdb))
{
  ...
  x = cor.test( pdb_elj$entropy_from_alignments, pdb_dssp$hbe, method='spearman', na.action="na.omit" )
  ...
  x = cor.test( pdb_elj$entropy_from_ddGs, pdb_dssp$hbe, method='spearman', na.action="na.omit" )
  ...
  x = cor.test( pdb_dssp$asa, pdb_dssp$hbe, method='spearman', na.action="na.omit" )
  ...
  x = cor.test( pdb_dssp$rsa, pdb_dssp$hbe, method='spearman', na.action="na.omit" )
  r.rsa_hbe = x$estimate
  p.rsa_hbe = x$p.value
  
  #x = cor.test( pdb_dssp$wcn_ca, pdb_dssp$hbe, method='spearman', na.action="na.omit" )
