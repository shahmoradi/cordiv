...
varnames_long = c('Evolutionary Rates (r4sJC)' , 'Number of Voronoi Cell Faces' , 'log10 ( Voronoi Cell Edge Length )'
                  , 'log10 ( Voronoi Cell Surface Area )' , 'log10 ( Voronoi Cell Volume )' , 'Voronoi Cell Eccentricity' , 'Voronoi Cell Sphericity')
...
for (i in 1:length(varnames_short))
{
  ...
  filename = paste0('../figures/adjacent_averaging_screen/only_voro/',varnames_short[i],'_voro.png')
