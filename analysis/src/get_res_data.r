# This R function takes in the residue properties of all proteins from DSSP, and PDB files and and combines them into a single long dataframe for further analysis at the pdb level.
