...
# Last updated by Amir Shahmoradi, Wednesday 7:38 PM, Aug 28 2014, Wilke Lab, ICMB, UT Austin
...
for (column in colnames(all_pdb_prop_subset))
{
  ...
  filename = paste0('../tables/pcr_rank/',column,'_PEV_projection_ordered.csv')
