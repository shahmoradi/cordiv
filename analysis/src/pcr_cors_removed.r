# This R code performs PCR analysis on the set of seqent-variable correlations in all_pdb_prop_select_wide.csv.
# Last updated by Amir Shahmoradi, Sunday 3:07 PM, Oct 19 2014, Wilke Lab, ICMB, UT Austin
...
for (column in not_in_pcr)
{
  ...
  filename = paste0('../tables/pcr/cors_removed/',column,'_PEV_projection_ordered.csv')
